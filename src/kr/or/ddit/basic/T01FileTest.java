...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("파일명 : "+ file.getName());		// 파일의 이름을 가져옴
		System.out.println("파일여부 : "+ file.isFile());		// 파일인지를 판별 (파일일 경우에 true / 아니면 false)
		System.out.println("디렉토리(폴더)여부 : "+ file.isDirectory());	 // 폴더인지를 판별 (폴더일 경우 true / 아니면 false)
		System.out.println("--------------------------------------");
		...
		System.out.println("경로 : " + file4.getPath());		// 생정자에 설정해 준 경로
